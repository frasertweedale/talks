...
% - This doesn't mean don't *make* assumptions about input.
%   But you have to validate data against those assumptions
%   and fail in a safe way when they are violated

% - Consider IFC, taint mode, etc
...
% Rust, C++ smart pointers, GC'd languages
...
\Large Corollary: return types shall express failure cases
\pause

\Large Corollary: use tools that ensure failure cases are handled
\end{frame}
\end{frame}
...
% think about:
% - how it could have been prevented (tooling)
% - how it could have been detected earlier
% - read others' results
% - share your results
% - train your programmers
