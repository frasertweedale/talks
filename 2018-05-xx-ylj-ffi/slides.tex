...
\NormalTok{foreign }\KeywordTok{import }\NormalTok{ccall "math.h sin"}
...
\NormalTok{databaseOpen path }\FunctionTok{=}
  \NormalTok{alloca }\FunctionTok{$} \NormalTok{\textbackslash{}ptr }\OtherTok{->} \KeywordTok{do}
    ...
    \KeywordTok{case} \NormalTok{toEnum (fromIntegral result) }\KeywordTok{of}
      \DataTypeTok{StatusSuccess} \OtherTok{->}
        \DataTypeTok{Right} \FunctionTok{.} \DataTypeTok{DatabaseHandle} \FunctionTok{<$>} \NormalTok{(peek ptr }\FunctionTok{>>=} \NormalTok{newForeignPtr_)}
...
\begin{Shaded}
\begin{Highlighting}[]
\OtherTok{tagsToList ::} \DataTypeTok{Tags} \OtherTok{->} \DataTypeTok{IO} \NormalTok{[}\DataTypeTok{Tag}\NormalTok{]}
\NormalTok{tagsToList (}\DataTypeTok{Tags} \NormalTok{ptr) }\FunctionTok{=} \NormalTok{go}
  \KeywordTok{where}
  \NormalTok{go ptr }\FunctionTok{=} \NormalTok{test ptr }\FunctionTok{>>=} \NormalTok{\textbackslash{}valid }\OtherTok{->} \KeywordTok{case} \NormalTok{valid }\KeywordTok{of}
  ...
  \NormalTok{mk }\FunctionTok{=} \NormalTok{tagFromCString}
\end{Highlighting}
\end{Shaded}
...
\NormalTok{query_create db s }\FunctionTok{=} \NormalTok{withCString s }\FunctionTok{$} \NormalTok{\textbackslash{}s' }\OtherTok{->}
  \NormalTok{withDatabaseHandle db }\FunctionTok{$} \NormalTok{\textbackslash{}db' }\OtherTok{->}
    \StringTok{\{#}\KeywordTok{call}\StringTok{ notmuch_query_create #\}} \NormalTok{db' s'}
      \FunctionTok{>>=} \NormalTok{fmap }\DataTypeTok{QueryHandle} \FunctionTok{.} \NormalTok{newForeignPtr query_destroy}

\NormalTok{foreign }\KeywordTok{import }\NormalTok{ccall "&notmuch_query_destroy"}
\OtherTok{  query_destroy ::} \DataTypeTok{FinalizerPtr} \NormalTok{a}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\OtherTok{messageAddTag ::} \DataTypeTok{Message} \DataTypeTok{'DatabaseModeReadWrite} \OtherTok{->} \DataTypeTok{Tag} \OtherTok{->} \DataTypeTok{IO} \NormalTok{()}
...
\KeywordTok{data} \DataTypeTok{Message} \NormalTok{(}\OtherTok{n ::} \DataTypeTok{Nat}\NormalTok{) (}\OtherTok{a ::} \DataTypeTok{DatabaseMode}\NormalTok{) }\FunctionTok{=} \DataTypeTok{Message} \DataTypeTok{MessageHandle}

\OtherTok{messageAddTag ::} \DataTypeTok{Message} \NormalTok{n} \DataTypeTok{'DatabaseModeReadWrite} \OtherTok{->} \DataTypeTok{Tag} \OtherTok{->} \DataTypeTok{IO} \NormalTok{()}
\NormalTok{messageAddTag msg tag }\FunctionTok{=} \NormalTok{void }\FunctionTok{$} \NormalTok{withMessage msg }\FunctionTok{$}
  \NormalTok{tagUseAsCString tag }\FunctionTok{.} \StringTok{\{#}\KeywordTok{call}\StringTok{ notmuch_message_add_tag #\}}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\OtherTok{messageFreeze ::} \DataTypeTok{Message} \NormalTok{n }\DataTypeTok{RW} \OtherTok{->} \DataTypeTok{IO} \NormalTok{(}\DataTypeTok{Message} \NormalTok{(n }\FunctionTok{+} \DecValTok{1}\NormalTok{) }\DataTypeTok{RW}\NormalTok{)}
...
\OtherTok{messageThaw ::} \NormalTok{(}\DecValTok{1} \FunctionTok{<=} \NormalTok{n) }\OtherTok{=>} \DataTypeTok{Message} \NormalTok{n }\DataTypeTok{RW} \OtherTok{->} \DataTypeTok{IO} \NormalTok{(}\DataTypeTok{Message} \NormalTok{(n }\FunctionTok{-} \DecValTok{1}\NormalTok{) }\DataTypeTok{RW}\NormalTok{)}
...
\OtherTok{withFrozenMessage ::} \NormalTok{(}\DataTypeTok{Message} \DecValTok{1} \DataTypeTok{RW} \OtherTok{->} \DataTypeTok{IO} \NormalTok{a) }\OtherTok{->} \DataTypeTok{Message} \DecValTok{0} \DataTypeTok{RW} \OtherTok{->} \DataTypeTok{IO} \NormalTok{a}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{foreign }\KeywordTok{import }\NormalTok{ccall        "notmuch.h notmuch_messages_valid"}
\OtherTok{  notmuch_messages_valid ::} \DataTypeTok{Messages} \OtherTok{->} \DataTypeTok{IO} \DataTypeTok{CInt}

\NormalTok{foreign }\KeywordTok{import }\NormalTok{ccall        "notmuch.h notmuch_messages_get"}
\OtherTok{  notmuch_messages_get ::} \DataTypeTok{Messages} \OtherTok{->} \DataTypeTok{IO} \DataTypeTok{CString}

\NormalTok{foreign }\KeywordTok{import }\NormalTok{ccall        "notmuch.h notmuch_messages_move_to_next"}
...
\NormalTok{messagesToList (}\DataTypeTok{Messages} \NormalTok{ptr) }\FunctionTok{=} \NormalTok{go}
  ...
  \NormalTok{go ptr }\FunctionTok{=} \NormalTok{test ptr }\FunctionTok{>>=} \NormalTok{\textbackslash{}valid }\OtherTok{->} \KeywordTok{case} \NormalTok{valid }\KeywordTok{of}
    ...
    \NormalTok{_ }\OtherTok{->} \NormalTok{(}\FunctionTok{:}\NormalTok{)}
          \FunctionTok{<$>} \NormalTok{(get ptr }\FunctionTok{>>=} \NormalTok{mk }\FunctionTok{>>=} \NormalTok{\textbackslash{}x }\OtherTok{->} \NormalTok{next ptr }\FunctionTok{$>} \NormalTok{x)}
          \FunctionTok{<*>} \NormalTok{unsafeInterleaveIO (go ptr)}
\end{Highlighting}
\end{Shaded}
